...
int clockPin = 12; //clock input pin
int q1Pin = 13; //Q output of flip-flop 1 of first IC 7474
int q2Pin = 14; //Q output of flip-flop 2 of first IC 7474
int dPin = 15; //D input of flip-flop of second IC 7474
int qPin = 16; //Q output of flip-flop of second IC 7474
