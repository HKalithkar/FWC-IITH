\def\mytitle{IMPLEMENTATION OF RANDOM NUMBER GENERATOR IN ARDUINO USING EMBEDDED C}
\def\mykeywords{}
...
\title{\mytitle}
\date{March 2023}
\author{Sai Harshith Kalithkar\\harshith.work@gmail.com\\FWC22118\\IIT Hyderabad-Future Wireless Communications Assignment-3}
\sloppy
\lstset{                                          
language=C++,                           
